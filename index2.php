  ...
  <body>
    ...
    <nav class="nav">
      <div class="container">
        ...
        <ul>
        <li><a class="current"href="index2.php" accesskey="1" title="">Home</a></li>
    ...
    <section class="container content">
      ...
      <div class="iw"><a href="/index2.php">back to top</a></div>
        <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><footer  class="footer2">  
