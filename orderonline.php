...
switch($_GET["action"]) {
	case "add":
		if(!empty($_POST["quantity"])) {
			...
			$itemArray = array($productByCode[0]["code"]=>array('name637'=>$productByCode[0]["name637"], 'code'=>$productByCode[0]["code"], 'quantity'=>$_POST["quantity"], 'price'=>$productByCode[0]["price"], 'image'=>$productByCode[0]["image"]));
  ...
  <nav class="nav">
      <div class="container">
        ...
        <li><a href="index2.php" accesskey="1" title="">Home</a></li>
				...
				<li><a class="current" href="orderonline.php" accesskey="4" title="">Order online </a></li>
    ...
    <div class="hero">
      <div class="container">
        ...
        <p>Strat buying bread you love!</p>
      </div>
    </div>
...
#删减选中的产品代码之处
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				<table>
				<tr>
				<td><img src="<?php echo $item["image"]; ?>"  class="cart-item-image" /><?php echo $item["name637"]; ?></td>
...
<div id="product-grid">
	...
	?>
		...
		<div class="image">
			...
			<div class="product-title"><?php echo $product_array[$key]["name637"]; ?></div>
